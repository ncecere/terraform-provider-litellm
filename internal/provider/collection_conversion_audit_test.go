...
var legacyCollectionConversionAllowlist = map[collectionAuditViolation]int{
	...
	{File: "resource_model.go", Symbol: "*ModelResource.createOrUpdateModel", Kind: "ignored ElementsAs diagnostics"}:                                      3,
	{File: "resource_model.go", Symbol: "*ModelResource.patchModel", Kind: "ignored ElementsAs diagnostics"}:                                               3,
	...
	{File: "resource_model.go", Symbol: "normalizeAdditionalParams", Kind: "discarded MapValue constructor diagnostics"}:                                   1,
	{File: "resource_model.go", Symbol: "normalizeAdditionalParams", Kind: "ignored ElementsAs diagnostics"}:                                               1,
